...
signals:
    ...
    // Forwarded from the Controllers page so MainWindow can pause the auto-map re-sync timer while
    // the Advanced per-player editor is open.
...
private:
    ...
    std::unique_ptr<ConfigureControllers> controllers_simple_tab;
