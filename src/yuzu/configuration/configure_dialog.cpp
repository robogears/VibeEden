...
ConfigureDialog::ConfigureDialog(QWidget* parent, HotkeyRegistry& registry_,
    ...
    : QDialog(parent), ui{std::make_unique<Ui::ConfigureDialog>()}, registry(registry_),
      ...
      controllers_simple_tab{
          std::make_unique<ConfigureControllers>(system_, input_subsystem, this)},
    ...
    ui->tabWidget->addTab(controllers_simple_tab.get(), tr("Controls"));
    ...
    connect(controllers_simple_tab.get(), &ConfigureControllers::AdvancedEditorVisibilityChanged,
            this, &ConfigureDialog::AdvancedEditorVisibilityChanged);
...
void ConfigureDialog::ApplyConfiguration() {
    ...
    controllers_simple_tab->ApplyConfiguration();
...
void ConfigureDialog::PopulateSelectionList() {
    const std::array<std::pair<QString, QList<QWidget*>>, 6> items{
        {{tr("General"),
         ...
         {tr("Controls"), {controllers_simple_tab.get()}}},
    };
